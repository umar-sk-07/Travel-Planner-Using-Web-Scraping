      ...
      <div className="z-10 w-full flex items-center">
        <NavbarBrand>
          ...
          >
            ...
            <span className="text-xl uppercase font-medium italic text-gray-500">
        ...
        <NavbarContent className="hidden sm:flex gap-4 " justify="center">
          ...
          <NavbarItem>
            <Link
              href="/search-flights"
              className={`${
                pathname.includes("flights") ? "text-danger-500" : "text-gray-500"
              }`}
            >
              Flights
            </Link>
          ...
          <NavbarItem>
            <Link
              href="/search-hotels"
              className={`${
                pathname.includes("hotels") ? "text-danger-500" : "text-gray-500"
              }`}
            >
              Hotels
            </Link>
